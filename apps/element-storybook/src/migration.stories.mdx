...
import { Badge, Chip, IconButton, MailIcon, ThemeProvider } from '@availity/element';

<Meta title="BS4 Migration/Getting Started Ext" />
...
- jumbotron
  - bootstrap got rid of this in bootstrap 5 and there are no plans on making an equivalent in Mui.
