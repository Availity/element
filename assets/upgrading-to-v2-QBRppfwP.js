import{j as e,M as l}from"./iframe-D77h7lRS.js";import{useMDXComponents as o}from"./index-CFKWXFXA.js";import"./preload-helper-PPVm8Dsz.js";function r(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Upgrading/Upgrading to v2"}),`
...
`]}),`
`,e.jsxs(n.h4,{id:"testing-in-availityworkflow-apps",children:["Testing in ",e.jsx(n.code,{children:"@availity/workflow"})," Apps"]}),`
`,e.jsxs(n.p,{children:["Element v2 packages are now published as ESM-only. If your test runner does not support ESM natively, you may need to transform ",e.jsx(n.code,{children:"@availity"})," packages:"]}),`
