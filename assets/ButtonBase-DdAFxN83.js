...
`,Gt=l.forwardRef(function(t,e){const r=lt({props:t,name:"MuiTouchRipple"}),{center:o=!1,classes:i={},className:s,...p}=r,[u,f]=l.useState([]),d=l.useRef(0),h=l.useRef(null);l.useEffect(()=>{h.current&&(h.current(),h.current=null)},[u]);const M=l.useRef(!1),V=wt(),g=l.useRef(null),D=l.useRef(null),C=l.useCallback(c=>{const{pulsate:y,rippleX:R,rippleY:I,rippleSize:j,cb:U}=c;f(E=>[...E,N.jsx(_t,{classes:{ripple:x(i.ripple,b.ripple),rippleVisible:x(i.rippleVisible,b.rippleVisible),ripplePulsate:x(i.ripplePulsate,b.ripplePulsate),child:x(i.child,b.child),childLeaving:x(i.childLeaving,b.childLeaving),childPulsate:x(i.childPulsate,b.childPulsate)},timeout:Q,pulsate:y,rippleX:R,rippleY:I,rippleSize:j},d.current)]),d.current+=1,h.current=U},[i]),$=l.useCallback((c={},y={},R=()=>{})=>{const{pulsate:I=!1,center:j=o||y.pulsate,fakeElement:U=!1}=y;if((c==null?void 0:c.type)==="mousedown"&&M.current){M.current=!1;return}(c==null?void 0:c.type)==="touchstart"&&(M.current=!0);const E=U?null:D.current,B=E?E.getBoundingClientRect():{width:0,height:0,left:0,top:0};let S,T,w;if(j||c===void 0||c.clientX===0&&c.clientY===0||!c.clientX&&!c.touches)S=Math.round(B.width/2),T=Math.round(B.height/2);else{const{clientX:z,clientY:L}=c.touches&&c.touches.length>0?c.touches[0]:c;S=Math.round(z-B.left),T=Math.round(L-B.top)}if(j)w=Math.sqrt((2*B.width**2+B.height**2)/3),w%2===0&&(w+=1);else{const z=Math.max(Math.abs((E?E.clientWidth:0)-S),S)*2+2,L=Math.max(Math.abs((E?E.clientHeight:0)-T),T)*2+2;w=Math.sqrt(z**2+L**2)}c!=null&&c.touches?g.current===null&&(g.current=()=>{C({pulsate:I,rippleX:S,rippleY:T,rippleSize:w,cb:R})},V.start(Xt,()=>{g.current&&(g.current(),g.current=null)})):C({pulsate:I,rippleX:S,rippleY:T,rippleSize:w,cb:R})},[o,C,V]),Y=l.useCallback(()=>{$({},{pulsate:!0})},[$]),F=l.useCallback((c,y)=>{if(V.clear(),(c==null?void 0:c.type)==="touchend"&&g.current){g.current(),g.current=null,V.start(0,()=>{F(c,y)});return}g.current=null,f(R=>R.length>0?R.slice(1):R),h.current=y},[V]);return l.useImperativeHandle(e,()=>({pulsate:Y,start:$,stop:F}),[Y,$,F]),N.jsx(Ht,{className:x(b.root,i.root,s),ref:D,...p,children:N.jsx(nt,{component:null,exit:!0,children:u})})});function qt(n){return vt("MuiButtonBase",n)}const Jt=ut("MuiButtonBase",["root","disabled","focusVisible"]),Qt=n=>{const{disabled:t,focusVisible:e,focusVisibleClassName:r,classes:o}=n,s=Dt({root:["root",t&&"disabled",e&&"focusVisible"]},qt,o);return e&&r&&(s.root+=` ${r}`),s},Zt=tt("button",{name:"MuiButtonBase",slot:"Root"})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Jt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),ce=l.forwardRef(function(t,e){const r=lt({props:t,name:"MuiButtonBase"}),{action:o,centerRipple:i=!1,children:s,className:p,component:u="button",disabled:f=!1,disableRipple:d=!1,disableTouchRipple:h=!1,focusRipple:M=!1,focusVisibleClassName:V,LinkComponent:g="a",onBlur:D,onClick:C,onContextMenu:$,onDragLeave:Y,onFocus:F,onFocusVisible:c,onKeyDown:y,onKeyUp:R,onMouseDown:I,onMouseLeave:j,onMouseUp:U,onTouchEnd:E,onTouchMove:B,onTouchStart:S,tabIndex:T=0,TouchRippleProps:w,touchRippleRef:z,type:L,...O}=r,A=l.useRef(null),m=zt(),ct=rt(m.ref,z),[v,K]=l.useState(!1);f&&v&&K(!1),l.useImperativeHandle(o,()=>({focusVisible:()=>{K(!0),A.current.focus()}}),[]);const pt=m.shouldMount&&!d&&!f;l.useEffect(()=>{v&&M&&!d&&m.pulsate()},[d,M,v,m]);const ft=P(m,"start",I,h),dt=P(m,"stop",$,h),ht=P(m,"stop",Y,h),mt=P(m,"stop",U,h),gt=P(m,"stop",a=>{v&&a.preventDefault(),j&&j(a)},h),bt=P(m,"start",S,h),Mt=P(m,"stop",E,h),Rt=P(m,"stop",B,h),yt=P(m,"stop",a=>{at(a.target)||K(!1),D&&D(a)},!1),Et=_(a=>{A.current||(A.current=a.currentTarget),at(a.target)&&(K(!0),c&&c(a)),F&&F(a)}),q=()=>{const a=A.current;return u&&u!=="button"&&!(a.tagName==="A"&&a.href)},xt=_(a=>{M&&!a.repeat&&v&&a.key===" "&&m.stop(a,()=>{m.start(a)}),a.target===a.currentTarget&&q()&&a.key===" "&&a.preventDefault(),y&&y(a),a.target===a.currentTarget&&q()&&a.key==="Enter"&&!f&&(a.preventDefault(),C&&C(a))}),Ct=_(a=>{M&&a.key===" "&&v&&!a.defaultPrevented&&m.stop(a,()=>{m.pulsate(a)}),R&&R(a),C&&a.target===a.currentTarget&&q()&&a.key===" "&&!a.defaultPrevented&&C(a)});let W=u;W==="button"&&(O.href||O.to)&&(W=g);const X={};W==="button"?(X.type=L===void 0?"button":L,X.disabled=f):(!O.href&&!O.to&&(X.role="button"),f&&(X["aria-disabled"]=f));const Tt=rt(e,A),ot={...r,centerRipple:i,component:u,disabled:f,disableRipple:d,disableTouchRipple:h,focusRipple:M,tabIndex:T,focusVisible:v},Pt=Qt(ot);return N.jsxs(Zt,{as:W,className:x(Pt.root,p),ownerState:ot,onBlur:yt,onClick:C,onContextMenu:dt,onFocus:Et,onKeyDown:xt,onKeyUp:Ct,onMouseDown:ft,onMouseLeave:gt,onMouseUp:mt,onDragLeave:ht,onTouchEnd:Mt,onTouchMove:Rt,onTouchStart:bt,ref:Tt,tabIndex:f?-1:T,type:L,...X,...O,children:[s,pt?N.jsx(Gt,{ref:ct,center:i,...w}):null]})});function P(n,t,e,r=!1){return _(o=>(e&&e(o),r||n[t](o),!0))}export{ce as B,nt as T,J as _};
