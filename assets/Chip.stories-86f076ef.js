...
}`,...(q=(V=t.parameters)==null?void 0:V.docs)==null?void 0:q.source},description:{story:"Inline counter styling is achieved by using size `small`. For counters that affix to the corner of an element see `Badge`.",...(A=(x=t.parameters)==null?void 0:x.docs)==null?void 0:A.description}}};const ne=["_Chip","_RemovableChip","_Avatar","_Status","_InlineCounter"];export{m as _Avatar,o as _Chip,t as _InlineCounter,i as _RemovableChip,s as _Status,ne as __namedExportsOrder,le as default};
//# sourceMappingURL=Chip.stories-86f076ef.js.map
