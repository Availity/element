import{a as n,j as t,F as a}from"./jsx-runtime-a3bcee63.js";import"./chunk-PCJTTTQV-42dcefe9.js";import{M as s}from"./index-9fe81f14.js";import{u as r}from"./index-da4379a2.js";import"./index-570b25c1.js";import"./_commonjsHelpers-042e6b4d.js";import"./iframe-e75254ab.js";import"../sb-preview/runtime.js";import"./react-18-b9b6ed02.js";import"./index-8a077077.js";import"./index-d475d2ea.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-16f43d9e.js";import"./_baseFor-53bad3ef.js";import"./index-e9d7ebdf.js";import"./_initCloneObject-31384e14.js";import"./index-356e4a49.js";const c=""+new URL("storybook_accessibility-7d010ae2.png",import.meta.url).href;function i(o){const e=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",a:"a"},r(),o.components);return t(a,{children:[n(s,{title:"BS4 Migration/508 Compliance"}),`
`,n(e.h1,{id:"508-compliance",children:"508 Compliance"}),`
`,t(e.p,{children:["The ",n(e.code,{children:"@availity/element"}),` library is built to be 508 compliant. However,
...
`,t(e.p,{children:["The components within ",n(e.code,{children:"@availity/element"}),` are designed from the beginning
in collaboration with the UX team and with 508 compliance in mind.`]}),`
`,t(e.p,{children:[`After development, we use three tools to test individual components for 508
...
`,t(e.p,{children:["Scanning your app using the ",n(e.a,{href:"https://chromewebstore.google.com/detail/wave-evaluation-tool/jbbplnpkjmmeebjpijfedlgcdilocofh",target:"_blank",rel:"nofollow noopener noreferrer",children:"WAVE extension"}),`
...
`,t(e.p,{children:[`In general it is important to use native html elements whenever possible
and for their intended purposes. When not possible, ensure you are using
the correct `,n(e.a,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA",target:"_blank",rel:"nofollow noopener noreferrer",children:"ARIA roles and attributes"}),"."]})]})}function x(o={}){const{wrapper:e}=Object.assign({},r(),o.components);return e?n(e,Object.assign({},o,{children:n(i,o)})):i(o)}export{x as default};
//# sourceMappingURL=508-compliance-f5a9a084.js.map
