import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as f}from"./index-BSuoOqEd.js";import{T as r}from"./index-7dkkVNWZ.js";import{q as i,h as c}from"./index-LinAfN8C.js";import{C as R}from"./Checkbox-DYMm0_cs.js";import{C as k}from"./Container-BRT0GL3j.js";import{F as n}from"./FormControlLabel-Bg8bewgW.js";import{B as F}from"./Box-BAprLmuU.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./Typography-CHtEfMke.js";import"./identifier-DhnHujDJ.js";import"./index-DtRw77fL.js";import"./extendSxProp-plByhdXY.js";import"./DefaultPropsProvider-B1sWsgx2.js";import"./useTheme-C_c7PR3o.js";import"./emotion-react.browser.esm-CVJjYY2z.js";import"./memoTheme-BwIkkReu.js";import"./styled-9znMky1q.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./generateUtilityClasses-DDbjFgb8.js";import"./generateUtilityClass-BtcU_pBl.js";import"./faCircleArrowRight-e2oTZTvX.js";import"./faUser-Dxmucm-1.js";import"./SvgIcon-enpUMgPP.js";import"./SwitchBase-D9HE_1I9.js";import"./useFormControl-BP1ipPfY.js";import"./useSlot-jI6_c_PV.js";import"./mergeSlotProps-C8ahzxnq.js";import"./isHostComponent-DVu5iVWx.js";import"./useForkRef-BIkqQIqh.js";import"./useControlled-DUUijreW.js";import"./ButtonBase-AdAh9sBA.js";import"./useTimeout-B9dULhq6.js";import"./TransitionGroupContext-CcytU7uK.js";import"./useEventCallback-Dvy07Fv6.js";import"./useEnhancedEffect-CIAiDanS.js";import"./isFocusVisible-B8k4qzLc.js";import"./createSvgIcon-DjY4rWdK.js";import"./mergeSlotProps-1djKqk8T.js";import"./styled-BN1MHGNr.js";import"./useThemeProps-DxTj-Mj7.js";import"./formControlState-Dq1zat_P.js";const a=f.forwardRef((o,t)=>e.jsx(R,{...o,ref:t,size:"medium"}));try{a.displayName="Checkbox",a.__docgenInfo={description:"",displayName:"Checkbox",props:{color:{defaultValue:null,description:`The color of the component.
It supports both default and custom theme colors, which can be added as shown in the
[palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).`,name:"color",required:!1,type:{name:'"error" | "primary"'}},slots:{defaultValue:{value:"{}"},description:"The components used for each slot inside.",name:"slots",required:!1,type:{name:"Partial<CheckboxSlots>"}},classes:{defaultValue:null,description:"Override or extend the styles applied to the component.",name:"classes",required:!1,type:{name:"Partial<CheckboxClasses>"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties"}},sx:{defaultValue:null,description:"The system prop that allows defining system overrides as well as additional CSS styles.",name:"sx",required:!1,type:{name:"SxProps<Theme>"}},defaultChecked:{defaultValue:null,description:"The default checked state. Use when the component is not controlled.",name:"defaultChecked",required:!1,type:{name:"boolean"}},autoFocus:{defaultValue:null,description:"",name:"autoFocus",required:!1,type:{name:"boolean"}},id:{defaultValue:null,description:"The id of the `input` element.",name:"id",required:!1,type:{name:"string"}},tabIndex:{defaultValue:null,description:"",name:"tabIndex",required:!1,type:{name:"number"}},onChange:{defaultValue:null,description:"Callback fired when the state is changed.\n@param event The event source of the callback.\nYou can pull out the new checked state by accessing `event.target.checked` (boolean).",name:"onChange",required:!1,type:{name:"(event: ChangeEvent<HTMLInputElement>, checked: boolean) => void"}},component:{defaultValue:null,description:"",name:"component",required:!1,type:{name:"ElementType<any, keyof IntrinsicElements>"}},action:{defaultValue:null,description:"A ref for imperative actions.\nIt currently only supports `focusVisible()` action.",name:"action",required:!1,type:{name:"Ref<ButtonBaseActions>"}},icon:{defaultValue:{value:"<CheckBoxOutlineBlankIcon />"},description:"The icon to display when the component is unchecked.",name:"icon",required:!1,type:{name:"ReactNode"}},slotProps:{defaultValue:{value:"{}"},description:"The props used for each slot inside.",name:"slotProps",required:!1,type:{name:"{ root?: SlotProps<ElementType<SwitchBaseProps, keyof IntrinsicElements>, CheckboxRootSlotPropsOverrides, CheckboxOwnerState>; input?: SlotProps<...>; }"}},disabled:{defaultValue:{value:"false"},description:"If `true`, the component is disabled.",name:"disabled",required:!1,type:{name:"boolean"}},focusVisibleClassName:{defaultValue:null,description:`This prop can help identify which element has keyboard focus.
...
The browser uses "on" as the default value.`,name:"value",required:!1,type:{name:"unknown"}},readOnly:{defaultValue:null,description:"",name:"readOnly",required:!1,type:{name:"boolean"}},required:{defaultValue:{value:"false"},description:"If `true`, the `input` element is required.",name:"required",required:!1,type:{name:"boolean"}},inputProps:{defaultValue:null,description:"[Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input#attributes) applied to the `input` element.\n@deprecated Use `slotProps.input` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.",name:"inputProps",required:!1,type:{name:"InputHTMLAttributes<HTMLInputElement>"}},inputRef:{defaultValue:null,description:"Pass a ref to the `input` element.\n@deprecated Use `slotProps.input.ref` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.",name:"inputRef",required:!1,type:{name:"Ref<any>"}},checkedIcon:{defaultValue:{value:"<CheckBoxIcon />"},description:"The icon to display when the component is checked.",name:"checkedIcon",required:!1,type:{name:"ReactNode"}},checked:{defaultValue:null,description:"If `true`, the component is checked.",name:"checked",required:!1,type:{name:"boolean"}},indeterminate:{defaultValue:{value:"false"},description:"If `true`, the component appears indeterminate.\nThis does not set the native input element to indeterminate due\nto inconsistent behavior across browsers.\nHowever, we set a `data-indeterminate` attribute on the `input`.",name:"indeterminate",required:!1,type:{name:"boolean"}},indeterminateIcon:{defaultValue:{value:"<IndeterminateCheckBoxIcon />"},description:"The icon to display when the component is indeterminate.",name:"indeterminateIcon",required:!1,type:{name:"ReactNode"}}}}}catch{}const Pe={title:"Form Components/Checkbox/Checkbox",component:a,tags:["autodocs"],argTypes:{readOnly:{table:{disable:!0}}}},d={render:o=>e.jsxs(k,{children:[e.jsx(r,{variant:"h1",marginTop:"1rem",children:"Examples"}),e.jsx(r,{variant:"body1",children:"Storybook controls do not apply to these"}),e.jsx(a,{defaultChecked:!0,inputProps:{"aria-label":"Default Checked example"}}),e.jsx(a,{inputProps:{"aria-label":"Default Unchecked example"}}),e.jsx(a,{inputProps:{"aria-label":"Disabled example"},disabled:!0}),e.jsx(a,{inputProps:{"aria-label":"Disabled Checked example"},disabled:!0,checked:!0}),e.jsx(r,{variant:"h1",children:"Playground"}),e.jsx(r,{variant:"body1",children:"Storybook controls apply to this component"}),e.jsx(a,{...o})]}),args:{color:"primary",inputProps:{"aria-label":"Playground example"}}},p={render:o=>e.jsxs(k,{children:[e.jsx(r,{variant:"h1",sx:{marginTop:"1rem"},children:"Examples"}),e.jsx(r,{variant:"body1",children:"Storybook controls do not apply to these"}),e.jsx(a,{defaultChecked:!0,inputProps:{"aria-label":"Default Checked example"},color:"error",icon:e.jsx(c,{}),checkedIcon:e.jsx(i,{})}),e.jsx(a,{inputProps:{"aria-label":"Default Unchecked example"},color:"error",icon:e.jsx(c,{}),checkedIcon:e.jsx(i,{})}),e.jsx(a,{disabled:!0,inputProps:{"aria-label":"Disabled example"},color:"error",icon:e.jsx(c,{}),checkedIcon:e.jsx(i,{})}),e.jsx(a,{disabled:!0,checked:!0,inputProps:{"aria-label":"Disabled Checked example"},color:"error",icon:e.jsx(c,{}),checkedIcon:e.jsx(i,{})}),e.jsx(r,{variant:"h1",children:"Playground"}),e.jsx(r,{variant:"body1",children:"Storybook controls apply to this component"}),e.jsx(a,{...o})]}),args:{color:"error",icon:e.jsx(c,{}),checkedIcon:e.jsx(i,{}),inputProps:{"aria-label":"Playground example"}}},h={render:o=>e.jsxs(k,{children:[e.jsx(r,{variant:"h1",sx:{marginTop:"1rem"},children:"Examples"}),e.jsx(r,{variant:"body1",children:"Storybook controls do not apply to these"}),e.jsx(n,{control:e.jsx(a,{defaultChecked:!0}),label:"Label"}),e.jsx(n,{required:!0,control:e.jsx(a,{}),label:"Required"}),e.jsx(n,{control:e.jsx(a,{disabled:!0}),label:"Disabled"}),e.jsx(r,{variant:"h1",children:"Playground"}),e.jsx(r,{variant:"body1",children:"Storybook controls apply to this component"}),e.jsx(n,{control:e.jsx(a,{...o}),label:"Label"})]}),args:{}},u={render:o=>{const[t,s]=f.useState(!1),b=y=>s(y.target.checked);return e.jsx(a,{...o,checked:t,onChange:b,inputProps:{"aria-label":"controlled"}})},args:{}},m={render:o=>{const[t,s]=f.useState([!0,!1]),b=l=>{s([l.target.checked,l.target.checked])},y=l=>{s([l.target.checked,t[1]])},D=l=>{s([t[0],l.target.checked])},_=e.jsxs(F,{sx:{display:"flex",flexDirection:"column",ml:3},children:[e.jsx(n,{label:"Child 1",control:e.jsx(a,{checked:t[0],onChange:y})}),e.jsx(n,{label:"Child 2",control:e.jsx(a,{checked:t[1],onChange:D})})]});return e.jsxs("div",{children:[e.jsx(n,{label:"Parent",control:e.jsx(a,{...o,checked:t[0]&&t[1],indeterminate:t[0]!==t[1],onChange:b})}),_]})},args:{}};var x,g,C;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...
  args: {}
}`,...(H=(L=m.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};const qe=["_Checkbox","_CustomCheckbox","_LabeledCheckbox","_ControlledCheckbox","_IndeterminateCheckbox"];export{d as _Checkbox,u as _ControlledCheckbox,p as _CustomCheckbox,m as _IndeterminateCheckbox,h as _LabeledCheckbox,qe as __namedExportsOrder,Pe as default};
