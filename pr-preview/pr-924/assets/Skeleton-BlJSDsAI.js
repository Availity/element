import{r as v,c as C,j as b,e as k,L as c,K as u}from"./iframe-DHkqGgbi.js";import{m as w}from"./memoTheme-vxEZSkJ8.js";import{g as x}from"./generateUtilityClass-BtcU_pBl.js";import{g as R}from"./generateUtilityClasses-DDbjFgb8.js";import{c as S,s as $}from"./styled-BFLY3dn7.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return x("MuiSkeleton",t)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return S({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},A,e)},r=u`
  0% {
    opacity: 1;
  }
