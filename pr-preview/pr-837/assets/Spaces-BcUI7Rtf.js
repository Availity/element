import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{r as _}from"./index-BSuoOqEd.js";import{h as Z}from"./index-DdNunzh7.js";import{i as oe}from"./index-DuRQpI0H.js";import{b as X,D as le,a as de,d as pe}from"./index-DXs8hFLY.js";import{B as G}from"./index-DS7md1Ks.js";import{q as k}from"./index-DLKRbc4C.js";import{i as ce}from"./index-DJKl12U0.js";import{d as ue}from"./dayjs.min-CfWDS3UC.js";import{R as me,I as ye,u as fe}from"./Img-DtUipdSC.js";import{C as ee}from"./index-B6vC4jns.js";import{G as ge,B as _e}from"./index-DWvMPRyT.js";import{T as he}from"./index-7dkkVNWZ.js";const L=e=>{const a=e.match(/(?:query|mutation|subscription)\s+([a-zA-Z_][a-zA-Z0-9_]*)/i);return a==null?void 0:a[1]},Ie={SPACES:(e,{spaces:a,spacesByConfig:t,spacesByPayer:i})=>({previousSpacesMap:a,previousSpacesByConfigMap:t,previousSpacesByPayerMap:i,error:void 0,loading:!1}),ERROR:(e,{error:a})=>({...e,loading:!1,error:a}),LOADING:(e,{loading:a})=>({...e,loading:a!==void 0?a:!e.loading})},Se=(e,a)=>{const{type:t}=a;return Ie[t](e,a)},x=async({query:e,clientId:a,variables:t,operationName:i})=>{const s={};a&&(s["X-Client-ID"]=a);const{data:{data:{configurationPagination:o}}}=await Z.create({query:e,variables:{...t},operationName:i||L(e)||"PuiSpacesCmpAnonymousOperation"},{headers:{...s}}),{pageInfo:{currentPage:n,hasNextPage:d},items:p}=o;return{items:p,currentPage:n,hasNextPage:d}},v=async({query:e,clientId:a,variables:t,_spaces:i=[],operationName:s})=>{const{items:o,currentPage:n,hasNextPage:d}=await x({query:e,clientId:a,variables:t,operationName:s});if(i.push(...o),d){const p={...t,page:n+1};return v({query:e,clientId:a,variables:p,_spaces:i,operationName:s})}return i};try{L.displayName="parseOperationName",L.__docgenInfo={description:"",displayName:"parseOperationName",props:{}}}catch{}try{x.displayName="fetchSpaces",x.__docgenInfo={description:"",displayName:"fetchSpaces",props:{query:{defaultValue:null,description:"The query sent to the avWebQL endpoint.",name:"query",required:!0,type:{name:"string"}},clientId:{defaultValue:null,description:"The Client ID obtained from APIConnect.",name:"clientId",required:!1,type:{name:"string"}},variables:{defaultValue:null,description:"The variables sent to the avWebQL endpoint.",name:"variables",required:!1,type:{name:"object"}},page:{defaultValue:null,description:"The page sent to the avWebQL endpoint.",name:"page",required:!1,type:{name:"string"}},operationName:{defaultValue:null,description:`Name for the GraphQL operation, used for debugging and monitoring.
...
Useful for if you already have the spaces in your app and don't want the spaces provider to have to fetch them again.`,name:"spaces",required:!1,type:{name:"Space[]"}}}}}catch{}try{O.displayName="useSpaces",O.__docgenInfo={description:"",displayName:"useSpaces",props:{}}}catch{}export{J as S,O as a,j as b,re as u};
