...
`,Pi={title:"BS4 Migration/Form Migration",tags:["autodocs"],parameters:{docs:{description:{component:`${Rt}`},source:{state:!0}}}},Ye=["Bulbasaur","Squirtle","Charmander"],E={render:()=>{var n;const i=Ke({textField:V().max(200,"Text Field cannot exceed 200 characters.").required("This field is required."),selectField:V().required("This Field is required.").nullable(),datePicker:Be().required("This Field is required.").nullable(),radio:V().required("A selection is required")}),e=o=>{var s;return!((s=i.describe().fields[o])!=null&&s.optional)||void 0},t=o=>console.log(o),r=Ae({defaultValues:{textField:"",selectField:void 0,datePicker:void 0,radio:""},mode:"onBlur",resolver:Et(i)});return p.jsx(Ee,{...r,children:p.jsxs("form",{onSubmit:r.handleSubmit(t),children:[p.jsx(Le,{}),p.jsx(je,{name:"textField",label:"Textfield",margin:"normal",fullWidth:!0,helperText:"Max 200 characters",required:e("textField")}),p.jsx(De,{name:"selectField",FieldProps:{margin:"normal",label:"Select Field",placeholder:"Value",required:e("selectField")},options:Ye}),p.jsx(Pe,{name:"datePicker",FieldProps:{label:"Date",margin:"normal",required:e("datePicker")}}),p.jsxs(Ne,{name:"radio",label:"Radio Group",row:!0,"aria-required":!0,required:e("radio"),children:[p.jsx(z,{control:p.jsx(M,{}),value:"1",label:"Option 1"}),p.jsx(z,{control:p.jsx(M,{}),value:"2",label:"Option 2"})]}),p.jsx(Re,{loading:(n=r==null?void 0:r.formState)==null?void 0:n.isSubmitting,type:"submit",variant:"contained",sx:{mt:2},children:"Submit"})]})})}},R={render:()=>{var t;const i=Ae({defaultValues:{textField:"",selectField:null,datePicker:null,radio:""}}),e=r=>console.log(r);return p.jsx(Ee,{...i,children:p.jsxs("form",{onSubmit:i.handleSubmit(e),children:[p.jsx(Le,{}),p.jsx(je,{name:"textField",label:"Textfield",margin:"normal",fullWidth:!0,required:!0,rules:{required:"This field is required",maxLength:{value:200,message:"This field must not exceed 200 characters"}},helperText:"Max 200 characters"}),p.jsx(De,{name:"selectField",rules:{required:"This field is required"},FieldProps:{margin:"normal",label:"Select Field",placeholder:"Value",required:!0},options:Ye}),p.jsx(Pe,{name:"datePicker",rules:{required:"This field is required"},FieldProps:{label:"Date",margin:"normal",required:!0}}),p.jsxs(Ne,{name:"radio",label:"Radio Group",row:!0,"aria-required":!0,required:!0,rules:{required:"This field is required"},children:[p.jsx(z,{control:p.jsx(M,{}),value:"1",label:"Option 1"}),p.jsx(z,{control:p.jsx(M,{}),value:"2",label:"Option 2"})]}),p.jsx(Re,{loading:(t=i==null?void 0:i.formState)==null?void 0:t.isSubmitting,type:"submit",variant:"contained",sx:{mt:2},children:"Submit"})]})})}},j={render:()=>p.jsxs(p.Fragment,{children:[p.jsx(ae,{margin:"normal",value:"value",label:"Read Only",id:"read-only",fullWidth:!0,slotProps:{input:{readOnly:!0}},helperText:"Read-only state should be used for values that cannot be changed by the user, but are still significant. i.e. when the value is populated based on another field value."}),p.jsx(ae,{margin:"normal",value:"value",label:"Disabled",id:"disabled",fullWidth:!0,disabled:!0,helperText:"Disabled state should be used for values that are not applicable currently, but could be enabled in a different state."})]})};var be,xe,ye,ge,Fe;E.parameters={...E.parameters,docs:{...(be=E.parameters)==null?void 0:be.docs,source:{originalSource:`{
  render: () => {
    const schema = yup.object({
...
}`,...(Ce=(Oe=j.parameters)==null?void 0:Oe.docs)==null?void 0:Ce.source},description:{story:"We are moving away from our extensive use of `disabled` fields in favor of `read-only` fields.\nThis is necessary for accessibility as `disabled` fields are not available to the keyboard/screenreader, so the filled in values cannot be seen.",...(qe=($e=j.parameters)==null?void 0:$e.docs)==null?void 0:qe.description}}};const Ni=["_YupValidation","_RHFRules","_DisabledFields"];export{j as _DisabledFields,R as _RHFRules,E as _YupValidation,Ni as __namedExportsOrder,Pi as default};
