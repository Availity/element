import{D as oe,r as _,j as l}from"./iframe-PQChuD5P.js";import{h as Z}from"./index-DVEc2Vv3.js";import{i as le}from"./index-Xdeyw5Qm.js";import{b as X,D as de,a as pe,d as ce}from"./index-CdCWOqIf.js";import{B as G}from"./index-CPbMBP85.js";import{q as k}from"./index-DfTyqBN3.js";import{i as ue}from"./index-BiBDMnSv.js";import{R as me,I as ye,u as fe}from"./Img-DFnY5dAR.js";import{C as ee}from"./index-B-RvsC8z.js";import{G as ge,B as _e}from"./index-CWw8B1ja.js";import{T as he}from"./index-D5f8Vp7A.js";const v=e=>e.match(/(?:query|mutation|subscription)\s+([a-zA-Z_][a-zA-Z0-9_]*)/i)?.[1],Ie={SPACES:(e,{spaces:a,spacesByConfig:t,spacesByPayer:r})=>({previousSpacesMap:a,previousSpacesByConfigMap:t,previousSpacesByPayerMap:r,error:void 0,loading:!1}),ERROR:(e,{error:a})=>({...e,loading:!1,error:a}),LOADING:(e,{loading:a})=>({...e,loading:a!==void 0?a:!e.loading})},Se=(e,a)=>{const{type:t}=a;return Ie[t](e,a)},V=async({query:e,clientId:a,variables:t,operationName:r})=>{const i={};a&&(i["X-Client-ID"]=a);const{data:{data:{configurationPagination:o}}}=await Z.create({query:e,variables:{...t},operationName:r||v(e)||"PuiSpacesCmpAnonymousOperation"},{headers:{...i}}),{pageInfo:{currentPage:s,hasNextPage:d},items:p}=o;return{items:p,currentPage:s,hasNextPage:d}},A=async({query:e,clientId:a,variables:t,_spaces:r=[],operationName:i})=>{const{items:o,currentPage:s,hasNextPage:d}=await V({query:e,clientId:a,variables:t,operationName:i});if(r.push(...o),d){const p={...t,page:s+1};return A({query:e,clientId:a,variables:p,_spaces:r,operationName:i})}return r};try{v.displayName="parseOperationName",v.__docgenInfo={description:"",displayName:"parseOperationName",props:{}}}catch{}try{V.displayName="fetchSpaces",V.__docgenInfo={description:"",displayName:"fetchSpaces",props:{query:{defaultValue:null,description:"The query sent to the avWebQL endpoint.",name:"query",required:!0,type:{name:"string"}},clientId:{defaultValue:null,description:"The Client ID obtained from APIConnect.",name:"clientId",required:!1,type:{name:"string"}},variables:{defaultValue:null,description:"The variables sent to the avWebQL endpoint.",name:"variables",required:!1,type:{name:"object"}},page:{defaultValue:null,description:"The page sent to the avWebQL endpoint.",name:"page",required:!1,type:{name:"string"}},operationName:{defaultValue:null,description:`Name for the GraphQL operation, used for debugging and monitoring.
