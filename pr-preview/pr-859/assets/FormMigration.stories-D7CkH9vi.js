...
`,bn={title:"BS4 Migration/Form Migration",tags:["autodocs"],parameters:{docs:{description:{component:`${yt}`},source:{state:!0}}}},De=["Bulbasaur","Squirtle","Charmander"],E={render:()=>{const i=Ee({textField:V().max(200,"Text Field cannot exceed 200 characters.").required("This field is required."),selectField:V().required("This Field is required.").nullable(),datePicker:Ce().required("This Field is required.").nullable(),radio:V().required("A selection is required")}),e=n=>!i.describe().fields[n]?.optional||void 0,t=n=>console.log(n),r=be({defaultValues:{textField:"",selectField:void 0,datePicker:void 0,radio:""},mode:"onBlur",resolver:xt(i)});return f.jsx(xe,{...r,children:f.jsxs("form",{onSubmit:r.handleSubmit(t),children:[f.jsx(we,{}),f.jsx(ge,{name:"textField",label:"Textfield",margin:"normal",fullWidth:!0,helperText:"Max 200 characters",required:e("textField")}),f.jsx(Fe,{name:"selectField",FieldProps:{margin:"normal",label:"Select Field",placeholder:"Value",required:e("selectField")},options:De}),f.jsx(ve,{name:"datePicker",FieldProps:{label:"Date",margin:"normal",required:e("datePicker")}}),f.jsxs(ke,{name:"radio",label:"Radio Group",row:!0,"aria-required":!0,required:e("radio"),children:[f.jsx(z,{control:f.jsx(M,{}),value:"1",label:"Option 1"}),f.jsx(z,{control:f.jsx(M,{}),value:"2",label:"Option 2"})]}),f.jsx(ye,{loading:r?.formState?.isSubmitting,type:"submit",sx:{mt:2},children:"Submit"})]})})}},R={render:()=>{const i=be({defaultValues:{textField:"",selectField:null,datePicker:null,radio:""}}),e=t=>console.log(t);return f.jsx(xe,{...i,children:f.jsxs("form",{onSubmit:i.handleSubmit(e),children:[f.jsx(we,{}),f.jsx(ge,{name:"textField",label:"Textfield",margin:"normal",fullWidth:!0,required:!0,rules:{required:"This field is required",maxLength:{value:200,message:"This field must not exceed 200 characters"}},helperText:"Max 200 characters"}),f.jsx(Fe,{name:"selectField",rules:{required:"This field is required"},FieldProps:{margin:"normal",label:"Select Field",placeholder:"Value",required:!0},options:De}),f.jsx(ve,{name:"datePicker",rules:{required:"This field is required"},FieldProps:{label:"Date",margin:"normal",required:!0}}),f.jsxs(ke,{name:"radio",label:"Radio Group",row:!0,"aria-required":!0,required:!0,rules:{required:"This field is required"},children:[f.jsx(z,{control:f.jsx(M,{}),value:"1",label:"Option 1"}),f.jsx(z,{control:f.jsx(M,{}),value:"2",label:"Option 2"})]}),f.jsx(ye,{loading:i?.formState?.isSubmitting,type:"submit",sx:{mt:2},children:"Submit"})]})})}},j={render:()=>f.jsxs(f.Fragment,{children:[f.jsx(ae,{margin:"normal",value:"value",label:"Read Only",id:"read-only",fullWidth:!0,slotProps:{input:{readOnly:!0}},helperText:"Read-only state should be used for values that cannot be changed by the user, but are still significant. i.e. when the value is populated based on another field value."}),f.jsx(ae,{margin:"normal",value:"value",label:"Disabled",id:"disabled",fullWidth:!0,disabled:!0,helperText:"Disabled state should be used for values that are not applicable currently, but could be enabled in a different state."})]})};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  render: () => {
    const schema = yup.object({
...
}`,...E.parameters?.docs?.source},description:{story:"Form with `@availity/element` controlled form components, `yup`, and `@hookform/resolvers/yup`",...E.parameters?.docs?.description}}};R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  render: () => {
    const methods = useForm({
      defaultValues: {
        textField: '',
...
}`,...R.parameters?.docs?.source},description:{story:"Form with `@availity/element` controlled form components using internal rules for validation.\n\nUseful for smaller forms where writing a full schema could be cumbersome.",...R.parameters?.docs?.description}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => <>
...
}`,...j.parameters?.docs?.source},description:{story:"We are moving away from our extensive use of `disabled` fields in favor of `read-only` fields.\nThis is necessary for accessibility as `disabled` fields are not available to the keyboard/screenreader, so the filled in values cannot be seen.",...j.parameters?.docs?.description}}};const xn=["_YupValidation","_RHFRules","_DisabledFields"];export{j as _DisabledFields,R as _RHFRules,E as _YupValidation,xn as __namedExportsOrder,bn as default};
