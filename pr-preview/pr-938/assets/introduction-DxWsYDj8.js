import{j as e,M as a,i as n}from"./iframe-DKvnFaXU.js";import{useMDXComponents as m}from"./index-pJxjbp9j.js";import"./preload-helper-PPVm8Dsz.js";const u=`# @availity/mui-autocomplete
...
## [3.0.3](https://github.com/Availity/element/compare/@availity/mui-autocomplete@3.0.2...@availity/mui-autocomplete@3.0.3) (2026-09-17)
...
## [3.0.2](https://github.com/Availity/element/compare/@availity/mui-autocomplete@3.0.1...@availity/mui-autocomplete@3.0.2) (2026-09-15)
...
## [3.0.1](https://github.com/Availity/element/compare/@availity/mui-autocomplete@3.0.0...@availity/mui-autocomplete@3.0.1) (2026-09-14)

### Dependency Updates

* \`mui-form-utils\` updated to version \`3.0.0\`
* \`mui-textfield\` updated to version \`3.0.0\`
## [3.0.0](https://github.com/Availity/element/compare/@availity/mui-autocomplete@2.2.7...@availity/mui-autocomplete@3.0.0) (2026-06-16)

### Dependency Updates

* \`mui-form-utils\` updated to version \`2.2.7\`
* \`mui-textfield\` updated to version \`2.2.7\`
* \`mui-icon\` updated to version \`2.2.7\`
* \`@availity/mock\` updated to version \`2.2.7\`
* \`mui-layout\` updated to version \`2.2.7\`
...
* \`@availity/mock\` updated to version \`2.2.4\`
## [2.2.4](https://github.com/Availity/element/compare/@availity/mui-autocomplete@2.2.3...@availity/mui-autocomplete@2.2.4) (2026-02-10)

### Dependency Updates

* \`mui-form-utils\` updated to version \`2.2.3\`
* \`mui-textfield\` updated to version \`2.2.3\`
## [2.2.3](https://github.com/Availity/element/compare/@availity/mui-autocomplete@2.2.2...@availity/mui-autocomplete@2.2.3) (2026-02-02)

### Dependency Updates

* \`mui-form-utils\` updated to version \`2.2.2\`
* \`mui-textfield\` updated to version \`2.2.2\`
* \`mui-icon\` updated to version \`2.2.2\`
...
* \`mui-form-utils\` updated to version \`1.2.7\`
* \`mui-textfield\` updated to version \`1.2.7\`
* \`mui-icon\` updated to version \`1.2.7\`
* \`mui-layout\` updated to version \`1.2.7\`
...
`;function o(t){return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Form Components/Uncontrolled Fields/Autocomplete/README"}),`
`,e.jsx(n,{children:u}),`
`,e.jsx(n,{children:l})]})}function d(t={}){const{wrapper:i}={...m(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(o,{...t})}):o()}export{d as default};
