import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as o}from"./index-DawnV9gJ.js";import"./DocsRenderer-CFRXHY34-o2TXTe9A.js";import{M as l}from"./index-B1WDdp3Q.js";import"./index-BSuoOqEd.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./iframe-DwOxitVN.js";import"./client-DFMpBjsa.js";import"./index-CCz_6dyq.js";import"./index-CRBziY_1.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";function r(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Upgrading to v2"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://mui.com/x/migration/migration-pickers-v7/",rel:"nofollow",children:"New DOM structure for the field"}),` moves away from the old text input. The new section list input is more accessible,
but removes any `,e.jsx(n.code,{children:"placeholder"})," from the field. If you are passing your own ",e.jsx(n.code,{children:"TextField"})," you will need to swap to a ",e.jsx(n.code,{children:"PickersTextField"}),"."]}),`
...
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["FileSelector/FileSelector2",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"isCloud"})," is true by default"]}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsxs(n.h4,{id:"jest-testing-in-availityworkflow-apps",children:["Jest Testing in ",e.jsx(n.code,{children:"@availity/workflow"})," Apps"]}),`
`,e.jsxs(n.p,{children:["Depending on your configuration you may need to add ",e.jsx(n.code,{children:"@availity"})," and ",e.jsx(n.code,{children:"axios"})," to the ignore transform list"]}),`
