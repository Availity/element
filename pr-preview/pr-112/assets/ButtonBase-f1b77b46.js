...
`),m.rippleVisible,ot,ee,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,it,ee,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,rt,({theme:e})=>e.transitions.easing.easeInOut),lt=a.forwardRef(function(t,i){const l=be({props:t,name:"MuiTouchRipple"}),{center:o=!1,classes:n={},className:r}=l,c=me(l,tt),[u,p]=a.useState([]),d=a.useRef(0),g=a.useRef(null);a.useEffect(()=>{g.current&&(g.current(),g.current=null)},[u]);const b=a.useRef(!1),x=a.useRef(0),h=a.useRef(null),R=a.useRef(null);a.useEffect(()=>()=>{x.current&&clearTimeout(x.current)},[]);const U=a.useCallback(f=>{const{pulsate:M,rippleX:T,rippleY:$,rippleSize:_,cb:O}=f;p(y=>[...y,I(at,{classes:{ripple:E(n.ripple,m.ripple),rippleVisible:E(n.rippleVisible,m.rippleVisible),ripplePulsate:E(n.ripplePulsate,m.ripplePulsate),child:E(n.child,m.child),childLeaving:E(n.childLeaving,m.childLeaving),childPulsate:E(n.childPulsate,m.childPulsate)},timeout:ee,pulsate:M,rippleX:T,rippleY:$,rippleSize:_},d.current)]),d.current+=1,g.current=O},[n]),F=a.useCallback((f={},M={},T=()=>{})=>{const{pulsate:$=!1,center:_=o||M.pulsate,fakeElement:O=!1}=M;if((f==null?void 0:f.type)==="mousedown"&&b.current){b.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(b.current=!0);const y=O?null:R.current,B=y?y.getBoundingClientRect():{width:0,height:0,left:0,top:0};let v,w,S;if(_||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)v=Math.round(B.width/2),w=Math.round(B.height/2);else{const{clientX:D,clientY:P}=f.touches&&f.touches.length>0?f.touches[0]:f;v=Math.round(D-B.left),w=Math.round(P-B.top)}if(_)S=Math.sqrt((2*B.width**2+B.height**2)/3),S%2===0&&(S+=1);else{const D=Math.max(Math.abs((y?y.clientWidth:0)-v),v)*2+2,P=Math.max(Math.abs((y?y.clientHeight:0)-w),w)*2+2;S=Math.sqrt(D**2+P**2)}f!=null&&f.touches?h.current===null&&(h.current=()=>{U({pulsate:$,rippleX:v,rippleY:w,rippleSize:S,cb:T})},x.current=setTimeout(()=>{h.current&&(h.current(),h.current=null)},nt)):U({pulsate:$,rippleX:v,rippleY:w,rippleSize:S,cb:T})},[o,U]),j=a.useCallback(()=>{F({},{pulsate:!0})},[F]),N=a.useCallback((f,M)=>{if(clearTimeout(x.current),(f==null?void 0:f.type)==="touchend"&&h.current){h.current(),h.current=null,x.current=setTimeout(()=>{N(f,M)});return}h.current=null,p(T=>T.length>0?T.slice(1):T),g.current=M},[]);return a.useImperativeHandle(i,()=>({pulsate:j,start:F,stop:N}),[j,F,N]),I(st,H({className:E(m.root,n.root,r),ref:R},c,{children:I(Qe,{component:null,exit:!0,children:u})}))}),ut=lt;function ct(e){return Ue("MuiButtonBase",e)}const pt=ge("MuiButtonBase",["root","disabled","focusVisible"]),ft=pt,dt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],ht=e=>{const{disabled:t,focusVisible:i,focusVisibleClassName:l,classes:o}=e,r=je({root:["root",t&&"disabled",i&&"focusVisible"]},ct,o);return i&&l&&(r.root+=` ${l}`),r},mt=te("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${ft.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),bt=a.forwardRef(function(t,i){const l=be({props:t,name:"MuiButtonBase"}),{action:o,centerRipple:n=!1,children:r,className:c,component:u="button",disabled:p=!1,disableRipple:d=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:x="a",onBlur:h,onClick:R,onContextMenu:U,onDragLeave:F,onFocus:j,onFocusVisible:N,onKeyDown:f,onKeyUp:M,onMouseDown:T,onMouseLeave:$,onMouseUp:_,onTouchEnd:O,onTouchMove:y,onTouchStart:B,tabIndex:v=0,TouchRippleProps:w,touchRippleRef:S,type:D}=l,P=me(l,dt),z=a.useRef(null),C=a.useRef(null),Re=ce(C,S),{isFocusVisibleRef:re,onFocus:Me,onBlur:Te,ref:ye}=Xe(),[L,X]=a.useState(!1);p&&L&&X(!1),a.useImperativeHandle(o,()=>({focusVisible:()=>{X(!0),z.current.focus()}}),[]);const[q,Ce]=a.useState(!1);a.useEffect(()=>{Ce(!0)},[]);const Ee=q&&!d&&!p;a.useEffect(()=>{L&&b&&!d&&q&&C.current.pulsate()},[d,b,L,q]);function V(s,ae,Ie=g){return W(le=>(ae&&ae(le),!Ie&&C.current&&C.current[s](le),!0))}const xe=V("start",T),ve=V("stop",U),Pe=V("stop",F),Ve=V("stop",_),Be=V("stop",s=>{L&&s.preventDefault(),$&&$(s)}),we=V("start",B),Se=V("stop",O),$e=V("stop",y),De=V("stop",s=>{Te(s),re.current===!1&&X(!1),h&&h(s)},!1),Le=W(s=>{z.current||(z.current=s.currentTarget),Me(s),re.current===!0&&(X(!0),N&&N(s)),j&&j(s)}),J=()=>{const s=z.current;return u&&u!=="button"&&!(s.tagName==="A"&&s.href)},Q=a.useRef(!1),ke=W(s=>{b&&!Q.current&&L&&C.current&&s.key===" "&&(Q.current=!0,C.current.stop(s,()=>{C.current.start(s)})),s.target===s.currentTarget&&J()&&s.key===" "&&s.preventDefault(),f&&f(s),s.target===s.currentTarget&&J()&&s.key==="Enter"&&!p&&(s.preventDefault(),R&&R(s))}),Fe=W(s=>{b&&s.key===" "&&C.current&&L&&!s.defaultPrevented&&(Q.current=!1,C.current.stop(s,()=>{C.current.pulsate(s)})),M&&M(s),R&&s.target===s.currentTarget&&J()&&s.key===" "&&!s.defaultPrevented&&R(s)});let Y=u;Y==="button"&&(P.href||P.to)&&(Y=x);const K={};Y==="button"?(K.type=D===void 0?"button":D,K.disabled=p):(!P.href&&!P.to&&(K.role="button"),p&&(K["aria-disabled"]=p));const Ne=ce(i,ye,z),se=H({},l,{centerRipple:n,component:u,disabled:p,disableRipple:d,disableTouchRipple:g,focusRipple:b,tabIndex:v,focusVisible:L}),_e=ht(se);return Oe(mt,H({as:Y,className:E(_e.root,c),ownerState:se,onBlur:De,onClick:R,onContextMenu:ve,onFocus:Le,onKeyDown:ke,onKeyUp:Fe,onMouseDown:xe,onMouseLeave:Be,onMouseUp:Ve,onDragLeave:Pe,onTouchEnd:Se,onTouchMove:$e,onTouchStart:we,ref:Ne,tabIndex:p?-1:v,type:D},K,P,{children:[r,Ee?I(ut,H({ref:Re,center:n},w)):null]}))}),St=bt;export{St as B,Qe as T,Z as _,W as u};
//# sourceMappingURL=ButtonBase-f1b77b46.js.map
