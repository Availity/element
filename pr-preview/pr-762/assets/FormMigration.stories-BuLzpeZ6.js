...
}`,...(Ce=(Oe=j.parameters)==null?void 0:Oe.docs)==null?void 0:Ce.source},description:{story:"We are moving away from our extensive use of `disabled` fields in favor of `read-only` fields.\nThis is necessary for accessibility as `disabled` fields are not available to the keyboard/screenreader, so the filled in values cannot be seen.",...(qe=($e=j.parameters)==null?void 0:$e.docs)==null?void 0:qe.description}}};const Di=["_YupValidation","_RHFRules","_DisabledFields"];export{j as _DisabledFields,R as _RHFRules,E as _YupValidation,Di as __namedExportsOrder,ji as default};
