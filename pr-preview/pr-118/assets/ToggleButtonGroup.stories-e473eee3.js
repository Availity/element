...
}`,...(_=(I=v.parameters)==null?void 0:I.docs)==null?void 0:_.source}}};var L,E,F;T.parameters={...T.parameters,docs:{...(L=T.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: (args: ToggleButtonGroupProps) => {
    const [value, setValue] = useState<string | null>('left');
    const handleValue = (event: React.MouseEvent<HTMLElement>, newValue: string | null) => {
      setValue(newValue);
...
//# sourceMappingURL=ToggleButtonGroup.stories-e473eee3.js.map
