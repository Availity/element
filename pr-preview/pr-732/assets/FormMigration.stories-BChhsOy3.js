...
}`,...(ve=(Fe=R.parameters)==null?void 0:Fe.docs)==null?void 0:ve.source},description:{story:"Form with `@availity/element` controlled form components using internal rules for validation.\n\nUseful for smaller forms where writing a full schema could be cumbersome.",...(Se=(ke=R.parameters)==null?void 0:ke.docs)==null?void 0:Se.description}}};const Ri=["_YupValidation","_RHFRules"];export{R as _RHFRules,E as _YupValidation,Ri as __namedExportsOrder,Ei as default};
