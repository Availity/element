import{j as e,M as s}from"./iframe-DKPLEfLw.js";import{useMDXComponents as o}from"./index-CXRjFIGg.js";import"./preload-helper-Dp1pzeXC.js";function r(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Upgrading to v1"}),`
...
`})}),`
`,e.jsxs(n.p,{children:["For More information see ",e.jsx(n.a,{href:"https://mui.com/material-ui/migration/migrating-from-deprecated-apis/#system-props",rel:"nofollow",children:"Material UI's Migrating From Deprecated APIs Guide"}),"."]})]})}function a(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{a as default};
