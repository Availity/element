import{j as e}from"./jsx-runtime-CcL-W3nW.js";import{useMDXComponents as o}from"./index-CfSBfIZi.js";import"./DocsRenderer-CFRXHY34-ZMI1I7cF.js";import{M as s}from"./index-Bf-CwPnd.js";import"./index-DcWiA9TO.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-CpPlinJ5.js";import"./client-BqYpGkAY.js";import"./index-BEx9gAkE.js";import"./index-BedKbVpA.js";import"./index-DrFu-skq.js";function r(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Upgrading to v1"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npx @availty/mui-codemod@latest v1.0.0/grid-v2-props <path/to/folder>
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npx @availty/mui-codemod@latest v1.0.0/system-props <path/to/folder>
`})}),`
`,e.jsxs(n.p,{children:["For More information see ",e.jsx(n.a,{href:"https://mui.com/material-ui/migration/migrating-from-deprecated-apis/#system-props",rel:"nofollow",children:"Material UI's Migrating From Deprecated APIs Guide"}),"."]})]})}function g(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{g as default};
