...
export const DownloadIcon = ({ ...props }: SvgIconProps): JSX.Element => <FaSvgIcon icon={faDownload} {...props} />;

export const DeleteIcon = ({ ...props }: SvgIconProps): JSX.Element => <FaSvgIcon icon={faTrash} {...props} />;
