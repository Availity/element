...
export const useLink = (spaceOrSpaceId, { clientId: propsClientId, linkAttributes = {} } = {}) => {
  ...
  const space = spaceFromSpacesProvider?.[0] || (typeof spaceOrSpaceId === 'object' ? spaceOrSpaceId : {});
