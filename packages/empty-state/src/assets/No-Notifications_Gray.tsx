export const NoNotifications = () => (
	...
	.st62{fill:none;stroke:#EEEFF2;stroke-width:4;stroke-linecap:round;stroke-miterlimit:10;}`}
      ...
      <g>
        ...
        <g>
          <path className="st47" d="M10.7,54.6c-7-18.4,2.3-39,20.7-45.9" />
          <path className="st47" d="M25,49.2c-4-10.5,1.3-22.3,11.8-26.3" />
          <path className="st47" d="M133.3,54.6c7-18.4-2.3-39-20.7-45.9" />
          <path className="st47" d="M119,49.2c4-10.5-1.3-22.3-11.8-26.3" />
        </g>
        <path
          className="st1"
