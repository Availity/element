  ...
  render: () => (
    <Grid container spacing={8}>
      <Grid xs={12} sm={6} component="nav" aria-labelledby='favorites-default-spacing-header'>
        <Typography variant="h6" component="div" id='favorites-default-spacing-header'>Default Spacing</Typography>
        <List>
          {[0, 1, 2, 3].map((value) => (
            <ListItem
              key={value}
      ...
      <Grid xs={12} sm={6} component="nav" aria-labelledby='favorites-dense-spacing-header'>
        <Typography variant="h6" component="div" id='favorites-dense-spacing-header'>Dense Spacing</Typography>
        <List dense >
          {[4, 5, 6, 7].map((value) => (
            <ListItem
              key={value}
